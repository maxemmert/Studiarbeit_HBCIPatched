...
@XmlType(name = "StructuredRemittanceInformation6", namespace = "urn:sepade:xsd:pain.008.001.01", propOrder = {
    "rfrdDocInf",
    "rfrdDocRltdDt",
    "rfrdDocAmt",
    "cdtrRefInf",
...
public class StructuredRemittanceInformation6 {
    ...
    @XmlElement(name = "CdtrRefInf", namespace = "urn:sepade:xsd:pain.008.001.01")
    protected CreditorReferenceInformation1 cdtrRefInf;
    @XmlElement(name = "Invcr", namespace = "urn:sepade:xsd:pain.008.001.01")
    protected PartyIdentification8 invcr;
    @XmlElement(name = "Invcee", namespace = "urn:sepade:xsd:pain.008.001.01")
    protected PartyIdentification8 invcee;
    @XmlElement(name = "AddtlRmtInf", namespace = "urn:sepade:xsd:pain.008.001.01")
