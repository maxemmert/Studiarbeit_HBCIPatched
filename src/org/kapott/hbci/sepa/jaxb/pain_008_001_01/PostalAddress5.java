...
@XmlType(name = "PostalAddress5", namespace = "urn:sepade:xsd:pain.008.001.01", propOrder = {
    "adrLine",
    "ctry"
})
public class PostalAddress5 {

    @XmlElement(name = "AdrLine", namespace = "urn:sepade:xsd:pain.008.001.01", required = true)
