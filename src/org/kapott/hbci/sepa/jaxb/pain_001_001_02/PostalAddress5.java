...
/**
 * <p>Java class for PostalAddress5 complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="AdrLine" type="{urn:sepade:xsd:pain.001.001.02}Max70Text" maxOccurs="2"/>
...
@XmlType(name = "PostalAddress5", namespace = "urn:sepade:xsd:pain.001.001.02", propOrder = {
    "adrLine",
    "ctry"
})
public class PostalAddress5 {

    @XmlElement(name = "AdrLine", namespace = "urn:sepade:xsd:pain.001.001.02", required = true)
